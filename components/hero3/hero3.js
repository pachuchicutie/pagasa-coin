...
import pagasaCoinImg from "/public/images/shapes/pagasa_coin.svg";
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            ...
            <p
              ...
              data-aos-delay="100"
            >
              Pagasa was the first Philippine eagle successfully bred and
              hatched in captivity through artificial insemination.
            </p>
            <ul
              className="btns_group unordered_list p-0"
              data-aos="fade-up"
              data-aos-duration="800"
              data-aos-delay="200"
            >
              ...
              <li>
                ...
                >
                  ...
                  <span className="btn_bg">
                    ...
                    >
                      <path
                        d="M0.446196 12.6322C-1.28952 6.27057 3.49938 0 10.0936 0H185.906C192.5 0 197.289 6.27059 195.553 12.6322L191.978 25.7355C191.037 29.1822 191.037 32.8178 191.978 36.2645L195.553 49.3678C197.289 55.7294 192.5 62 185.906 62H10.0936C3.49938 62 -1.28952 55.7294 0.446193 49.3678L4.02134 36.2644C4.96171 32.8178 4.96172 29.1822 4.02134 25.7356L0.446196 12.6322Z"
                        fill="#FFFFFF"
                      />
                    </svg>
                  </span>
          ...
          <div className="col-lg-6">
            <div className="pepecoin_hero_image position-relative">
              <div className="pepe_coin_image">
                <Image src={pagasaCoinImg} alt="Pepe Coin" />
              </div>
