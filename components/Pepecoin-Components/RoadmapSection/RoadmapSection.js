...
import pagasaCoinImage from "/public/images/shapes/pagasa_coin.svg";
...
const RoadmapSection = () => {
  return (
    <section
      className="pepecoin_roadmap_section section_space pb-0 section_decoration"
      id="id_pepecoin_roadmap_section"
    >
      <div className="container">
        ...
        >
          <h2 className="heading_text text-uppercase mb-0 text-white">
            Roadmap
          </h2>
        </div>
      ...
      <div
        className="decoration_item shape_tree"
        data-aos="fade-right"
        data-aos-duration="800"
        data-aos-delay="200"
      >
      ...
      {/* <div
        className="decoration_item shape_cartoon_1"
        data-aos="fade-right"
        data-aos-duration="800"
      >
      ...
      <div className="decoration_item pepe_coin_image">
        <Image src={pagasaCoinImage} alt="Pagasa Coin" />
      </div>
    </section>
  );
};
