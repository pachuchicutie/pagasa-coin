    ...
    <footer className="pepecoin_site_footer">
          ...
          <div className="col-lg-6">
            <div className="pepecoin_heading_block">
              ...
              <p className="heading_description mb-0">
                $PAGASA has no association with the real "Pag-asa" eagle or the
                organizations that named or adopted him. This token is simply
                paying homage to a national symbol we all love and recognize.
              </p>
            </div>
      ...
      <div className="footer_bottom text-center">
        <p className="copyright_text m-0 text-uppercase text-white">
          Copyright© 2025 Pagasa. All rights reserved.
        </p>
      </div>
    </footer>
  );
