...
import pagasaImage from "/public/images/shapes/pagasa_cartoon_12.png";
...
const TokenomicsSection = () => {
  return (
    <section
      id="id_pepecoin_tokenomics_section"
      className="pepecoin_tokenomics_section section_space section_decoration bg-white overflow-hidden"
    >
      <div className="container">
        <div
          className="pepecoin_heading_block text-center mt-lg-5"
          data-aos="fade-up"
        ...
        <div
          className="pepecoin_token_supply"
          style={{
            backgroundImage: `url(${"/images/shapes/shape_sign_board_2.webp"})`,
          }}
        >
          <div className="row align-items-center">
            <div className="col-lg-7">
              ...
              <div className="token_supply_value">
                <span className="odometer text-primary" data-count="1000000000">
                  <CountUp end={1000000000} enableScrollSpy scrollSpyOnce />
                </span>
              </div>
              <p className="mb-0">
                100% Fair Launch. No Insiders. No Friends & Family. Just 100%
                Pure Decentralized Community Ownership.
              </p>
            </div>
            <div className="col-lg-5">
              <div className="image_block">
                <Image src={pagasaImage} alt="Pagasa" />
              </div>
            </div>
          </div>
