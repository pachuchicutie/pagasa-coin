...
const steps = [
  ...
  },
  {
    ...
    description:
      "Go to pump.fun (or jup.ag) on Chrome or your Phantom browser. Connect your wallet, paste the token address (CA) into the search bar, select the coin, and confirm. Sign the wallet prompt to complete.",
  },
  {
    number: "04",
    title: "Switch SOL for $PAGASA",
    description:
      "Switch SOL for $PAGASA. We have ZERO taxes so you don’t need to worry about buying with a specific slippage, although you may need to use slippage during times of market volatility.",
  },
];
...
const FeaturesSection = () => {
  ...
  return (
    <section
      className="pepecoin_feature_section section_space pb-0 z-2 section_decoration"
      id="id_pepecoin_feature_section"
    >
      <div className="container">
        <div
          className="pepecoin_heading_block text-center"
          data-aos="fade-up"
          ...
          {steps.map((step, index) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${"/images/shapes/pepecoin_feature_bg_image_1.webp"})`,
                }}
              >
                <div
                  className="feature_serial_number"
                  style={{
                    backgroundImage: `url(${"/images/shapes/shape_cloud_1.png"})`,
                  }}
                >
                  {step.number}
                </div>
        ...
        <div
          className="btns_group pb-0 mt-4 justify-content-center"
          data-aos="fade-up"
          data-aos-duration="800"
          data-aos-delay="500"
        >
